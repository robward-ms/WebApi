...
namespace Microsoft.AspNet.OData
{
    ...
    public class EnableQueryAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuted(ActionExecutedContext actionExecutedContext)
        {
            ...
            if (response != null && response.IsSuccessStatusCode() && response.Body != null)
            {
        ...
        //private ODataQueryContext GetODataQueryContext(object response, HttpRequestMessage request, ActionDescriptor actionDescriptor)
        //{
        ...
        //    HttpRequestMessage request, ActionDescriptor actionDescriptor,
        ...
        //private object ExecuteQuery(object response, HttpRequestMessage request, ActionDescriptor actionDescriptor, ODataQueryContext queryContext)
        //{
