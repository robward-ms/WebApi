...
namespace Microsoft.AspNet.OData
{
    ...
    {
        /// <inheritdoc/>
        //protected async override Task<HttpResponse> SendAsync(
        //    HttpRequest request,
        ...
        //internal Task<HttpResponse> SendAsync(HttpRequestMessage request)
        //{
        ...
        private static object GetSingleEntityObject(HttpResponse response)
        {
