...
namespace Microsoft.AspNet.OData.Formatter
{
    ...
    internal static class ODataOutputFormatterHelper
    {
        ...
        /// <inheritdoc/>
        public static ODataPayloadKind? GetPayloadKind(Type type, ODataPath path, Func<ODataPayloadKind?> getClrObjectResponsePayloadKind)
        {
            if (type == null)
            {
                throw Error.ArgumentNull("type");
            ...
            {
                payloadKind = GetEdmObjectPayloadKind(type, path);
            }
            else
            {
                payloadKind = getClrObjectResponsePayloadKind();
            }
        ...
        /// </summary>
        private static ODataPayloadKind? GetEdmObjectPayloadKind(Type type, ODataPath path)
        {
            if (path != null && path.IsCountRequest())
            {
