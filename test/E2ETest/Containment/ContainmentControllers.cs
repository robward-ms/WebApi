...
namespace Microsoft.Test.E2E.AspNet.OData.Containment
{
    public class AccountsController : TestController
    {
        ...
        [HttpPut]
        [ODataRoute("Accounts({key})/PayinPIs({navKey})/Statement")]
        public ITestActionResult PutStatement(int key, int navKey, EdmEntityObject statementObject)
        {
        ...
        public ITestActionResult PatchPremiumAccount(int key, Delta<PremiumAccount> delta)
        {
        ...
        public ITestActionResult PostToPayinPIsFromAccount(int key, PaymentInstrument pi)
        {
            var account = _dataSource.Accounts.Single(a => a.AccountID == key);
    ...
    public class AnonymousAccountController : TestController
    {
        private static ContainmentDataSource _dataSource = null;
