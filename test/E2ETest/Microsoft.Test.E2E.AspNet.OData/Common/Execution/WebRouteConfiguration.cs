...
namespace Microsoft.Test.E2E.AspNet.OData.Common.Execution
{
    ...
    public class WebRouteConfiguration : IRouteBuilder
    {
        ...
        public ODataConventionModelBuilder CreateConventionModelBuilder()
        {
            ...
            {
                return new ODataConventionModelBuilder(_fullScopePartManager);
            }
        ...
        /// <param name="handler"></param>
        /// <returns></returns>
        public IETagHandler GetETagHandler()
        {
            return routeBuilder.ServiceProvider.GetRequiredService<IETagHandler>();
        }
    }
#else
