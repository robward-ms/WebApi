...
{
    public class ForeignKeyCustomersController : TestController
    {
    ...
    public class ForeignKeyOrdersController : TestController
    {
    ...
    // ActionOnDelete = none
    public class ForeignKeyCustomersNoCascadeController : TestController
    {
    ...
    public class ForeignKeyOrdersNoCascadeController : TestController
    {
