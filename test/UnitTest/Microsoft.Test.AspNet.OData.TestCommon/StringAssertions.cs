...
namespace Microsoft.Test.AspNet.OData.TestCommon
{
    ...
    //    //public new static void Equal(string expected, string actual, bool ignoreCase = false, bool ignoreLineEndingDifferences = false, bool ignoreWhiteSpaceDifferences = false)
    //    //{
