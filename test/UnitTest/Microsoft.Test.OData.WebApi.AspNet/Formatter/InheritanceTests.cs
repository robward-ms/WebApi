...
namespace Microsoft.Test.OData.WebApi.AspNet.Formatter
{
    public class InheritanceTests
    {
        ...
        public void Can_Patch_DerivedType_To_Action_Expecting_BaseType()
        {
            ...
            request.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("application/json"));
            AddRequestInfo(request);
            request.Content = new StringContent("{ '@odata.type': '#Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Motorcycle', 'CanDoAWheelie' : false }");
            request.Content.Headers.ContentType = MediaTypeWithQualityHeaderValue.Parse("application/json");
        ...
        {
            // Arrange
            StringContent content = new StringContent("{ '@odata.type' : '#Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Motorcycle' }");
            ...
            Assert.Throws<ODataException>(
                ...
                "An resource with type 'Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Motorcycle' was found, " +
                "but it is not assignable to the expected type 'Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car'. " +
        ...
        {
            Assert.Equal("#Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Motorcycle", (string)result["@odata.type"]);
        ...
        {
            Assert.Equal("#Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car", (string)result["@odata.type"]);
