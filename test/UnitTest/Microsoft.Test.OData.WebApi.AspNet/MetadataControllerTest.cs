...
namespace Microsoft.Test.OData.WebApi.AspNet
{
    public class MetadataControllerTest
    {
        ...
        public void DollarMetadata_Works_ForNullableReferencialConstraint_WithCustomReferentialConstraints()
        {
            ...
            // non-nullable
            Assert.Contains("<Property Name=\"SupplierId\" Type=\"Edm.Int32\" />", payload);
            Assert.Contains("<NavigationProperty Name=\"Supplier\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FkSupplier\">", payload);
            Assert.Contains("<ReferentialConstraint Property=\"SupplierId\" ReferencedProperty=\"Id\" />", payload);

            // nullable
            Assert.Contains("<Property Name=\"SupplierKey\" Type=\"Edm.Int32\" Nullable=\"false\" />", payload);
            Assert.Contains("<NavigationProperty Name=\"SupplierNav\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FkSupplier\" Nullable=\"false\">", payload);
            Assert.Contains("<ReferentialConstraint Property=\"SupplierKey\" ReferencedProperty=\"Id\" />", payload);
        }
        ...
        public void DollarMetadata_Works_ForNullableReferencialConstraint_WithForeignKeyAttributeAndRequiredAttribute()
        {
            ...
            Assert.Contains("<NavigationProperty Name=\"Supplier\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FkSupplier2\" Nullable=\"false\">", payload);
            Assert.Contains("<ReferentialConstraint Property=\"SupplierId\" ReferencedProperty=\"Id\" />", payload);

            // nullable
            Assert.Contains("<Property Name=\"SupplierKey\" Type=\"Edm.String\" />", payload);
            Assert.Contains("<NavigationProperty Name=\"SupplierNav\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FkSupplier2\">", payload);
            Assert.Contains("<ReferentialConstraint Property=\"SupplierKey\" ReferencedProperty=\"Id\" />", payload);
        }
        ...
        public void DollarMetadata_Works_ForNullableReferencialConstraint_WithForeignKeyDiscovery()
        {
            ...
            const string expect =
                ...
                "<NavigationProperty Name=\"Supplier\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FkSupplier\" Nullable=\"false\">" +
                    "<ReferentialConstraint Property=\"FkSupplierId\" ReferencedProperty=\"Id\" />" +
                "</NavigationProperty>" +
                "<NavigationProperty Name=\"Supplier2\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FkSupplier2\" Nullable=\"false\">" +
                    "<ReferentialConstraint Property=\"FkSupplier2Id\" ReferencedProperty=\"Id\" />" +
                "</NavigationProperty>" +
                "<NavigationProperty Name=\"Supplier3\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FkSupplier3\">" +
        ...
        public void DollarMetadata_Works_WithOnDeleteAction()
        {
            ...
            const string expect =
                ...
                "<NavigationProperty Name=\"Customer\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.ForeignCustomer\" Nullable=\"false\">" +
        ...
        public void DollarMetadata_Works_WithMultipleReferentialConstraints()
        {
            // Arrange
            const string expect =
                "<NavigationProperty Name=\"Customer\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.MultiForeignCustomer\" Nullable=\"false\">" +
        ...
        public void DollarMetadata_Works_WithPrincipalKeyOnBaseType_ButBaseTypeNotInEdmModel()
        {
            // Arrange
            const string expect =
                "<NavigationProperty Name=\"DerivedProp\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.DerivedPrincipalEntity\">" +
        ...
        public void DollarMetadata_Works_WithInheritanceOpenComplexType()
        {
            ...
            Assert.True(response.IsSuccessStatusCode);
            Assert.Equal("application/xml", response.Content.Headers.ContentType.MediaType);
            Assert.Contains("<ComplexType Name=\"FormatterUsAddress\" BaseType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FormatterAddress\" OpenType=\"true\">",
                response.Content.ReadAsStringAsync().Result);
        }
        ...
        public void DollarMetadata_Works_WithDerivedOpenComplexType()
        {
            ...
            "<edmx:DataServices>" +
                "<Schema Namespace=\"Microsoft.Test.OData.WebApi.AspNet.Formatter\" xmlns=\"http://docs.oasis-open.org/odata/ns/edm\">" +
                    "<ComplexType Name=\"ComplexBaseType\">" +
                        "<Property Name=\"BaseProperty\" Type=\"Edm.String\" />" +
                    "</ComplexType>" +
                    "<ComplexType Name=\"ComplexDerivedOpenType\" BaseType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.ComplexBaseType\" OpenType=\"true\">" +
        ...
        public void DollarMetadata_Works_WithActionParameterNullable_ReturnTypeNullable()
        {
            ...
            "<Schema Namespace=\"Default\" xmlns=\"http://docs.oasis-open.org/odata/ns/edm\">" +
                "<Action Name=\"NullableAction\" IsBound=\"true\">" +
                    "<Parameter Name=\"bindingParameter\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FormatterPerson\" />" +
                    "<Parameter Name=\"param\" Type=\"Edm.String\" Unicode=\"false\" />" +
                    "<ReturnType Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FormatterAddress\" />" +
                "</Action>" +
                "<Action Name=\"NonNullableAction\" IsBound=\"true\">" +
                    "<Parameter Name=\"bindingParameter\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FormatterPerson\" />" +
                    "<Parameter Name=\"param\" Type=\"Edm.String\" Nullable=\"false\" Unicode=\"false\" />" +
                    "<ReturnType Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FormatterAddress\" Nullable=\"false\" />" +
                "</Action>" +
        ...
        public void DollarMetadata_Works_WithDerivedEntityTypeWithOwnKeys()
        {
            ...
            "<Schema Namespace=\"Microsoft.Test.OData.WebApi.AspNet.Formatter\" xmlns=\"http://docs.oasis-open.org/odata/ns/edm\">" +
                "<EntityType Name=\"AbstractEntityType\" Abstract=\"true\">" +
                    "<Property Name=\"IntProperty\" Type=\"Edm.Int32\" Nullable=\"false\" />" +
                "</EntityType>" +
                "<EntityType Name=\"SubEntityType\" BaseType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.AbstractEntityType\">" +
                    "<Key>" +
                        "<PropertyRef Name=\"SubKey\" />" +
                    "</Key>" +
                    "<Property Name=\"SubKey\" Type=\"Edm.Int32\" Nullable=\"false\" />" +
                "</EntityType>" +
                "<EntityType Name=\"AnotherSubEntityType\" BaseType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.AbstractEntityType\">" +
                    "<Key>" +
        ...
        public void DollarMetadata_Works_WithConcurrencyVocabuaryAnnotation()
        {
            // Arrange
            const string expectMetadata =
                "<EntitySet Name=\"Customers\" EntityType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.CustomerWithConcurrencyAttribute\">" +
        ...
        public void RequiredAttribute_Works_OnComplexTypeProperty()
        {
            ...
            // Assert
            Assert.Contains(
                "<Property Name=\"Address\" Type=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.FormatterAddress\" Nullable=\"false\" />",
                responseString);

            Assert.Contains(
                "<Property Name=\"Addresses\" Type=\"Collection(Microsoft.Test.OData.WebApi.AspNet.Formatter.FormatterAddress)\" Nullable=\"false\" />",
                responseString);
        }
        ...
        public void DollarMetadata_Works_WithNavigationPropertyBindingOnMultiplePath()
        {
          ...
          const string expectMetadata =
            "<EntityContainer Name=\"Container\">" +
                "<EntitySet Name=\"Customers\" EntityType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingCustomer\">" +
                    "<NavigationPropertyBinding Path=\"Location/City\" Target=\"Cities\" />" +
                "</EntitySet>" +
                "<EntitySet Name=\"Cities\" EntityType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingCity\" />" +
            "</EntityContainer>";
        ...
        public void DollarMetadata_Works_WithNavigationPropertyBindingOnMultiplePath_WithDerived()
        {
            ...
            const string expectMetadata =
              "<EntityContainer Name=\"Container\">" +
                  "<EntitySet Name=\"Customers\" EntityType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingCustomer\">" +
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipLocation/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCity\" Target=\"Cities_A\" />" +
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipLocation/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCities\" Target=\"Cities_B\" />" +
                  "</EntitySet>" +
                  "<EntitySet Name=\"Cities_A\" EntityType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingCity\" />" +
                  "<EntitySet Name=\"Cities_B\" EntityType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingCity\" />" +
              "</EntityContainer>";
            ...
            const string expectMetadata =
              "<EntityContainer Name=\"Container\">" +
                  "<EntitySet Name=\"Customers\" EntityType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingCustomer\">" +
                      ...
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipLocation/City\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipAddresses/City\" Target=\"Cities\" />" +
                      ...
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipLocation/Cities\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipAddresses/Cities\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Location/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCity\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Address/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCity\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Addresses/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCity\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipLocation/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCity\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipAddresses/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCity\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Location/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCities\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Address/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCities\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Addresses/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCities\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipLocation/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCities\" Target=\"Cities\" />" +
                      "<NavigationPropertyBinding Path=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipAddresses/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCities\" Target=\"Cities\" />" +
                  "</EntitySet>" +
                  "<EntitySet Name=\"Cities\" EntityType=\"Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingCity\" />" +
              "</EntityContainer>";
