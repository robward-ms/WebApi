    ...
    public class ODataCountTest
    {
        ...
        public static TheoryDataSet<string, int> DollarCountData
        {
            get
            {
                ...
                data.Add("DollarCountEntities/Microsoft.Test.OData.WebApi.AspNet.Routing.DerivedDollarCountEntity/$count", 5);
                ...
                data.Add("DollarCountEntities(5)/EnumCollectionProp/$count?$filter=$it has Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Color'Green'", 2);
                ...
                data.Add("UnboundFunctionReturnsEntityCollection()/Microsoft.Test.OData.WebApi.AspNet.Routing.DerivedDollarCountEntity/$count", 11);
                ...
                data.Add("DollarCountEntities/Default.BoundFunctionReturnsEntityCollection()/Microsoft.Test.OData.WebApi.AspNet.Routing.DerivedDollarCountEntity/$count", 5);
        ...
        public class DollarCountEntitiesController : ODataController
        {
            ...
            [HttpGet]
            [ODataRoute("UnboundFunctionReturnsEntityCollection()/Microsoft.Test.OData.WebApi.AspNet.Routing.DerivedDollarCountEntity/$count")]
            ...
            [HttpGet]
            [EnableQuery]
            [ODataRoute("DollarCountEntities/Default.BoundFunctionReturnsEntityCollection()/Microsoft.Test.OData.WebApi.AspNet.Routing.DerivedDollarCountEntity/$count")]
