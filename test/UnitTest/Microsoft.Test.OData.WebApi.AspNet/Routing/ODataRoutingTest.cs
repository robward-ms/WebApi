...
namespace Microsoft.Test.OData.WebApi.AspNet.Routing
{
    public class ODataRoutingTest
    {
        ...
        public static TheoryDataSet<string, string, string> ControllerRoutes
        {
            get
            {
                return new TheoryDataSet<string, string, string>
                {
                    ...
                    // entity set / cast
                    { "GET", "RoutingCustomers/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP", "GetRoutingCustomersFromVIP" },
                    { "POST", "RoutingCustomers/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP", "PostRoutingCustomerFromVIP" },
                    ...
                    { "GET", "RoutingCustomers(10)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Products", "GetProducts(10)" },
                    { "GET",
                        "RoutingCustomers(10)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/RelationshipManager",
                        "GetRelationshipManagerFromVIP(10)" },
                    // structural properties
                    { "GET", "RoutingCustomers(10)/Name", "GetName(10)" },
                    { "GET", "RoutingCustomers(10)/Address", "GetAddress(10)" },
                    { "GET", "RoutingCustomers(10)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Name", "GetName(10)" },
                    { "GET", "RoutingCustomers(10)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Company", "GetCompanyFromVIP(10)" },
                    // refs
                    ...
                    { "GET", "RoutingCustomers(10)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Name/$value", "GetName(10)" },
                    { "GET", "RoutingCustomers(10)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Company/$value", "GetCompanyFromVIP(10)" },
                    // actions on entities by key
                    { "POST", "RoutingCustomers(1)/Default.GetRelatedRoutingCustomers", "GetRelatedRoutingCustomers(1)" },
                    { "POST",
                        "RoutingCustomers(1)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Default.GetRelatedRoutingCustomers",
                        "GetRelatedRoutingCustomers(1)" },
                    { "POST",
                        "RoutingCustomers(1)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Default.GetSalesPerson",
                        "GetSalesPersonOnVIP(1)" },
                    // actions on entity sets
                    { "POST", "RoutingCustomers/Default.GetProducts", "GetProducts" },
                    { "POST", "RoutingCustomers/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Default.GetProducts", "GetProducts" },
                    { "POST",
                    ...
                    { "GET",
                        ...
                        "TopProductIdByCityAndModel(1, any, 2)" },
                    { "GET",
                        "Products(1)/Microsoft.Test.OData.WebApi.AspNet.Routing.ImportantProduct/Default.TopProductId",
                        "TopProductId(1)" },
                    ...
                    { "GET",
                        ...
                        "TopProductOfAllByCityAndModel(any, 2)" },
                    { "GET",
                        "Products/Microsoft.Test.OData.WebApi.AspNet.Routing.ImportantProduct/Default.TopProductOfAllByCity(city='any')",
                        "TopProductOfAllByCity(any)" },
                    // functions bound to the base and derived type
                    { "GET", "RoutingCustomers(4)/Default.GetOrdersCount()", "GetOrdersCount_4" },
                    { "GET",
                        "RoutingCustomers(5)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Default.GetOrdersCount()",
                        "GetOrdersCountOnVIP_5" },
                    { "GET",
                        "RoutingCustomers(6)/Microsoft.Test.OData.WebApi.AspNet.Routing.SpecialVIP/Default.GetOrdersCount()",
                        "GetOrdersCountOnVIP_6" },
                    { "GET", "RoutingCustomers(7)/Default.GetOrdersCount(factor=3)", "GetOrdersCount_(7,3)" },
                    { "GET",
                        "RoutingCustomers(8)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Default.GetOrdersCount(factor=4)",
                        "GetOrdersCount_(8,4)" },
                    { "GET",
                        "RoutingCustomers(9)/Microsoft.Test.OData.WebApi.AspNet.Routing.SpecialVIP/Default.GetOrdersCount(factor=5)",
                        "GetOrdersCount_(9,5)" },
                    ...
                    { "GET",
                        "RoutingCustomers/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Default.GetAllEmployees()",
                        "GetAllEmployeesOnCollectionOfVIP" },
                    { "GET",
                        "RoutingCustomers/Microsoft.Test.OData.WebApi.AspNet.Routing.SpecialVIP/Default.GetAllEmployees()",
                        "GetAllEmployeesOnCollectionOfVIP" },
                    // functions only bound to derived type
                    { "GET", "RoutingCustomers(5)/Default.GetSpecialGuid()", "~/entityset/key/unresolved" },
                    { "GET",
                        "RoutingCustomers(5)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/Default.GetSpecialGuid()",
                        "~/entityset/key/cast/unresolved" },
                    { "GET",
                        "RoutingCustomers(5)/Microsoft.Test.OData.WebApi.AspNet.Routing.SpecialVIP/Default.GetSpecialGuid()",
                        "GetSpecialGuid_5" },
                    // functions with enum type parameter
                    { "GET",
                        "RoutingCustomers/Default.BoundFuncWithEnumParameters(" +
                            "SimpleEnum=Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'1'," +
                            "FlagsEnum=Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Four')",
                        "BoundFuncWithEnumParameters(Second,One, Four)" },
                    { "GET",
                        "RoutingCustomers/Default.BoundFuncWithEnumParameterForAttributeRouting(" +
                            "SimpleEnum=Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First')",
                        "BoundFuncWithEnumParameterForAttributeRouting(First)" },
                    { "GET",
                        "UnboundFuncWithEnumParameters(LongEnum=Microsoft.Test.OData.WebApi.TestCommon.Types.LongEnum'ThirdLong'," +
                            "FlagsEnum=Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'7')",
                    ...
                    { "GET",
                        "UnboundFuncWithEnumParameters(LongEnum=Microsoft.Test.OData.WebApi.TestCommon.Types.LongEnum'ThirdLong'," +
                            "FlagsEnum=Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Two, Four')",
                        "UnboundFuncWithEnumParameters(ThirdLong,One, Two, Four)" },
                    { "GET",
                        "UnboundFuncWithEnumParameters(LongEnum=@long,FlagsEnum=@flags)?" +
                            "@long=Microsoft.Test.OData.WebApi.TestCommon.Types.LongEnum'ThirdLong'&" +
                            "@flags=Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'7'",
                        "UnboundFuncWithEnumParameters(ThirdLong,One, Two, Four)" },
                    { "GET",
                        "UnboundFuncWithEnumParameters(LongEnum=@long,FlagsEnum=@flags)?" +
                            "@long=Microsoft.Test.OData.WebApi.TestCommon.Types.LongEnum'ThirdLong'&" +
                            "@flags=Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Two, Four'",
                        "UnboundFuncWithEnumParameters(ThirdLong,One, Two, Four)" },
                    // unmapped requests
        ...
        public static TheoryDataSet<string, string, string> MoreFunctionRouteData
        {
            get
            {
                return new TheoryDataSet<string, string, string>
                {
                    ...
                    {
                        "GET",
                        "RoutingCustomers(10)/Default.CanMoveToAddress(address=@p)?@p={\"@odata.type\":\"Microsoft.Test.OData.WebApi.AspNet.Routing.Address\",\"Street\":\"NE 24th St.\",\"City\":\"Redmond\",\"ZipCode\":\"9001\"}",
                    ...
                    // Collection of complex
                    {
                        "GET", "RoutingCustomers(10)/Default.MoveToAddresses(addresses=@p)?" +
                               "@p=[{\"@odata.type\":\"Microsoft.Test.OData.WebApi.AspNet.Routing.Address\",\"Street\":\"NE 24th St.\",\"City\":\"Redmond\",\"ZipCode\":\"9001\"}," +
                               "{\"@odata.type\":\"Microsoft.Test.OData.WebApi.AspNet.Routing.Address\",\"Street\":\"NE 24th St.\",\"City\":\"Redmond\",\"ZipCode\":\"9001\"}]",
                    ...
                    {
                        "GET",
                        "RoutingCustomers(10)/Default.EntityTypeFunction(product=@p)?@p={\"@odata.type\":\"Microsoft.Test.OData.WebApi.AspNet.Routing.Product\",\"ID\":9,\"Name\":\"Phone\"}",
                    ...
                    // Feed (Collection of entity)
                    {
                        "GET", "RoutingCustomers(10)/Default.CollectionEntityTypeFunction(products=@p)" +
                               "?@p=[{\"@odata.type\":\"Microsoft.Test.OData.WebApi.AspNet.Routing.Product\",\"ID\":9,\"Name\":\"Phone\"}," +
                               "{\"@odata.type\":\"Microsoft.Test.OData.WebApi.AspNet.Routing.SpecialProduct\",\"ID\":9,\"Name\":\"Phone\",\"Value\":9}]",
        ...
        [InlineData("EntityTypeFunction(product=@p)?@p={\"@odata.type\":\"Microsoft.Test.OData.WebApi.AspNet.Routing.Product\",\"id\":9,\"Name\":\"Phone\"}")] // should be "ID"
        ...
        [Theory]
        [InlineData("EnumCustomers?$filter=Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Color'Unknown' eq null", "The string 'Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Color'Unknown'' is not a valid enumeration type constant.")]
    ...
    public class RoutingCustomersController : ODataController
    {
        ...
        // ~/RoutingCustomers(7)/Microsoft.Test.OData.WebApi.AspNet.Routing.VIP/GetOrdersCount(factor=2)
        // ~/RoutingCustomers(9)/Microsoft.Test.OData.WebApi.AspNet.Routing.SpecialVIP/GetOrdersCount(factor=5)
