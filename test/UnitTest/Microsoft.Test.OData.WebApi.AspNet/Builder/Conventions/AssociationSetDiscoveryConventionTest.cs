    ...
    public class AssociationSetDiscoveryConventionTest
    {
        ...
        public void GetTargetNavigationSource_Throws_IfTargetEntityTypeIsMissing()
        {
            ...
            Assert.Throws<InvalidOperationException>(
                ...
                "Could not find the target entity type for the navigation property 'SamplePropertyName' on entity type 'Microsoft.Test.OData.WebApi.AspNet.Builder.Conventions.AssociationSetDiscoveryConventionTest'.");
        }
