...
namespace Microsoft.Test.OData.WebApi.AspNet.Builderr
{
    public class EntitySetTest
    {
        ...
        public void CanAddBinding_For_DerivedNavigationProperty()
        {
            ...
            var binding = Assert.Single(entitySet.FindNavigationPropertyBindings(edmNavProperty));
            Assert.Same(target, binding.Target);
            Assert.Equal("Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Motorcycle/Manufacturer", binding.Path.Path);
        }
        ...
        public void AddNavigationLink_For_NavigationPropertyInHierarchy_Throws()
        {
            ...
            Assert.ThrowsArgument(
                () => vehicles.HasNavigationPropertyLink(navProperty, new NavigationLinkBuilder((ctxt, property) => new Uri("http://works/"), followsConventions: false)),
                "navigationProperty",
                "The declaring entity type 'Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Motorcycle' " +
                "of the given navigation property is not a part of the entity type " +
                "'Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Vehicle' hierarchy of the entity set or singleton 'vehicles'.");
        }
        ...
        public void CanConfigureManyBinding_For_NavigationPropertiesInDerivedType()
        {
            ...
            IEdmNavigationPropertyBinding binding = Assert.Single(vehicles.FindNavigationPropertyBindings(motorcycleManufacturerProperty));
            Assert.Same(motorcycleManufacturerPropertyTargetSet, binding.Target);
            Assert.Equal("Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Motorcycle/Manufacturers", binding.Path.Path);
        }
        ...
        public void CreateEdmModelWithEntitySetFromAbstractEntityTypeWithoutKey_Throws()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => builder.GetEdmModel(),
                "The entity set or singleton 'Customers' is based on type 'Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Customer' that has no keys defined.");
        }
        ...
        public void CanConfigureBindingPath_NavigationProperties_WithDerivedType()
        {
            ...
            Assert.Equal("Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipLocation/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCity", binding.Path.Path);
            ...
            Assert.Equal("Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingVipCustomer/VipLocation/Microsoft.Test.OData.WebApi.AspNet.Formatter.BindingUsAddress/UsCities", binding.Path.Path);
