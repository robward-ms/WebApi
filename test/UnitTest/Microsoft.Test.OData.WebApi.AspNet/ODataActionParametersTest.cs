...
namespace Microsoft.Test.OData.WebApi.AspNet
{
    public class ODataActionParametersTest
    {
        ...
        [InlineData("Drive", "Vehicles(Model=6,Name='6')/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car/org.odata.Drive")]
        [InlineData("Drive", "MyVehicle/org.odata.Drive")]
        [InlineData("Drive", "MyVehicle/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car/org.odata.Drive")]
        ...
        [InlineData("Vehicles(Model=6,Name='6')/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car/Drive")]
        [InlineData("MyVehicle/Drive")]
        [InlineData("MyVehicle/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car/Drive")]
        ...
        [Theory]
        [InlineData("Vehicles(Model=8,Name='8')/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car/org.odata.Wash")]
        [InlineData("MyVehicle/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car/org.odata.Wash")]
        ...
        [Theory]
        [InlineData("Vehicles(Model=8,Name='8')/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car/customize.NSAction")]
        [InlineData("MyVehicle/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car/customize.NSAction")]
        ...
        public void ParserThrows_ODataException_when_multiple_overloads_found()
        {
            ...
            Assert.Throws<ODataException>(() =>
                new DefaultODataPathHandler().Parse(model, _serviceRoot, "Vehicles/Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Car(Model=8,Name='8')/org.odata.Park"),
