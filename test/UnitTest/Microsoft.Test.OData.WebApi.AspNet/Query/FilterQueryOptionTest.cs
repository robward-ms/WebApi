    ...
    public class FilterQueryOptionTest
    {
        ...
        public static TheoryDataSet<string, int[]> EnumModelTestFilters
        {
            get
            {
                ...
                {
                    // Simple Enums
                    { "Simple eq Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First'", new int[] { 1, 3 } },
                    { "Simple eq Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'0'", new int[] { 1, 3 } },
                    { "Simple eq Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'Fourth'", new int[] { } },
                    { "Simple eq Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'3'", new int[] { } },
                    { "Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First' eq Simple", new int[] { 1, 3 } },
                    { "Simple eq cast('0',Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum)", new int[] { 1, 3} },
                    { "Simple eq cast('First','Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum')", new int[] { 1, 3} },
                    { "Simple eq null", new int[] { } },
                    { "null eq Simple", new int[] { } },
                    { "Simple eq SimpleNullable", new int[] { 1 } },
                    { "Simple has Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First'", new int[] { 1, 2, 3, 5, 6 } },
                    { "Simple has Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'0'", new int[] { 1, 2, 3, 5, 6 } },
                    { "Simple has Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'Second'", new int[] { 5 } },
                    { "SimpleNullable eq Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First'", new int[] { 1 } },
                    { "Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First' eq SimpleNullable", new int[] { 1 } },
                    { "SimpleNullable eq null", new int[] { 3, 5 } },
                    { "null eq SimpleNullable", new int[] { 3, 5 } },

                    // Long enums
                    { "Long eq Microsoft.Test.OData.WebApi.TestCommon.Types.LongEnum'SecondLong'", new int[] { 2 } },
                    { "Long eq Microsoft.Test.OData.WebApi.TestCommon.Types.LongEnum'FourthLong'", new int[] { } },
                    { "Long eq Microsoft.Test.OData.WebApi.TestCommon.Types.LongEnum'3'", new int[] { } },

                    // Byte enums
                    { "Byte eq Microsoft.Test.OData.WebApi.TestCommon.Types.ByteEnum'SecondByte'", new int[] { 2 } },

                    // SByte enums
                    { "SByte eq Microsoft.Test.OData.WebApi.TestCommon.Types.SByteEnum'SecondSByte'", new int[] { 2 } },

                    // Short enums
                    { "Short eq Microsoft.Test.OData.WebApi.TestCommon.Types.ShortEnum'SecondShort'", new int[] { 2 } },

                    // UShort enums
                    { "UShort eq Microsoft.Test.OData.WebApi.TestCommon.Types.UShortEnum'SecondUShort'", new int[] { 2 } },

                    // UInt enums
                    { "UInt eq Microsoft.Test.OData.WebApi.TestCommon.Types.UIntEnum'SecondUInt'", new int[] { 2 } },

                    // Flag enums
                    { "Flag eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Four'", new int[] { 1 } },
                    { "Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Four' eq Flag", new int[] { 1 } },
                    { "Flag eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'0'", new int[] { } },
                    { "Flag eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'1'", new int[] { 5 } },
                    { "Flag eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'5'", new int[] { 1 } },
                    { "Flag has Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Four'", new int[] { 1 } },
                    { "Flag has Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One'", new int[] { 1, 2, 5 } },
                    { "Flag eq null", new int[] { } },
                    { "null eq Flag", new int[] { } },
                    { "Flag eq FlagNullable", new int[] { 1 } },
                    { "FlagNullable eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Four'", new int[] { 1 } },
                    { "Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Four' eq FlagNullable", new int[] { 1 } },
                    ...
                    { "Flag eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One,Four'", new int[] { 1 } },
                    { "Flag eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One,    Four'", new int[] { 1 } },
                    { "Flag eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'Four, One'", new int[] { 1 } },

                    // Other expressions
                    { "Flag ne Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'One, Four'", new int[] { 2, 3, 5, 6 } },
                    { "Flag eq FlagNullable and Simple eq SimpleNullable", new int[] { 1 } },
                    { "Simple gt Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First'", new int[] { 2, 5, 6 } },
                    { "Flag ge Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'Four,One'", new int[] { 1, 3, 6 } }
                };
            }
        }
        ...
        public static TheoryDataSet<string, int[]> CastModelTestFilters
        {
            get
            {
                return new TheoryDataSet<string, int[]>
                {
                    ...
                    { "cast('Two, Four',Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum) has FlagsEnumProp", new int[] { 2, 3 } },
                    ...
                    { "cast(StringProp,Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum) eq null", new int[] { 1, 2, 3 } },
        ...
        public static TheoryDataSet<string, string, int[]> ParameterAliasTestFilters
        {
            get
            {
                return new TheoryDataSet<string, string, int[]>
                {
                    ...
                    { "FlagsEnumProp has @p", "Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'Two'", new int[] { 2, 3 } },
                    { "NullableSimpleEnumProp ne @p", "Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'1'", new int[] { 1, 3 } },
        ...
        [InlineData("null has Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First'", typeof(ODataException))]
        [InlineData("Id has Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'First'", typeof(ODataException))]
        ...
        [Theory]
        [InlineData("Simple eq Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum'4'")]
        [InlineData("Flag eq Microsoft.Test.OData.WebApi.TestCommon.Types.FlagsEnum'8'")]
        ...
        [InlineData("cast('123',Microsoft.Test.OData.WebApi.TestCommon.Types.SimpleEnum) ne 'First'", typeof(ODataException))]
