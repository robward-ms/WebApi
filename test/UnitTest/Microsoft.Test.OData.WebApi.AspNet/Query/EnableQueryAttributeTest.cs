...
namespace Microsoft.Test.OData.WebApi.AspNet.Query
{
    public class EnableQueryAttributeTest
    {
        ...
        public void ValidateQuery_Throws_With_Null_Request()
        {
            ...
            var options = new ODataQueryOptions(new ODataQueryContext(model, typeof(Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Customer)), request);
        ...
        public void ApplyQuery_Throws_With_Null_Queryable()
        {
            ...
            EnableQueryAttribute attribute = new EnableQueryAttribute();
            var model = new ODataModelBuilder().Add_Customer_EntityType().Add_Customers_EntitySet().GetEdmModel();
            var options = new ODataQueryOptions(new ODataQueryContext(model, typeof(Microsoft.Test.OData.WebApi.AspNet.Builder.TestModels.Customer)), message);
