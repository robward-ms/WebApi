...
{
    /// <summary>
    /// A stream used with ><see cref="TestContextBuilder"/>.
    /// </summary>
    internal class TestResponseStream : Stream
    {
        ...
        internal TestResponseStream(Func<Task> onFirstWriteAsync, Action abortRequest)
        {
